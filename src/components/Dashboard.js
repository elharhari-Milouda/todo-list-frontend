            ...
            <div class="card-body">
              ...
              <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                ...
                <div class="col-sm-3 pl-0 pl-sm-3">
                  <div class="badge badge-inverse-success mt-3 mt-sm-0">
                    {" "}
                    +7.7%{" "}
                  </div>
                </div>
        ...
        <div class="col-xl-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <a class="text-black mt-3 mb-0 d-block h6" href="#">
                View all <i class="mdi mdi-chevron-right"></i>
              </a>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              <div
                ...
                class="datepicker table-responsive"
              ></div>
            </div>
          </div>
        </div>
